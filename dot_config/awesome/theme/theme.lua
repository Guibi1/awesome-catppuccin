...
-- Mocha Color Theme from "github.com/catppuccin" --
...
theme.font_name  = "Fantasque Sans "
theme.font       = theme.font_name .. "10"

theme.icons_path = themes_path .. "assets/icons/"
theme.music      = themes_path .. "assets/music.png"
...
theme.titlebar_close_button_normal                    = themes_path .. "titlebar/unfocus.svg"
theme.titlebar_close_button_focus                     = themes_path .. "titlebar/close.svg"
theme.titlebar_close_button_normal_hover              = themes_path .. "titlebar/close_hover.svg"
theme.titlebar_close_button_focus_hover               = themes_path .. "titlebar/close_hover.svg"

theme.titlebar_minimize_button_normal                 = themes_path .. "titlebar/unfocus.svg"
theme.titlebar_minimize_button_focus                  = themes_path .. "titlebar/minimize.svg"
theme.titlebar_minimize_button_normal_hover           = themes_path .. "titlebar/minimize_hover.svg"
theme.titlebar_minimize_button_focus_hover            = themes_path .. "titlebar/minimize_hover.svg"

theme.titlebar_ontop_button_normal_inactive           = themes_path .. "titlebar/unfocus.svg"
theme.titlebar_ontop_button_focus_inactive            = themes_path .. "titlebar/ontop.svg"

theme.titlebar_ontop_button_normal_active             = themes_path .. "titlebar/unfocus.svg"
theme.titlebar_ontop_button_focus_active              = themes_path .. "titlebar/ontop.svg"
...
theme.titlebar_maximized_button_normal_active         = themes_path .. "titlebar/unfocus.svg"
theme.titlebar_maximized_button_focus_active          = themes_path .. "titlebar/maximize.svg"
theme.titlebar_maximized_button_normal_active_hover   = themes_path .. "titlebar/maximize_hover.svg"
theme.titlebar_maximized_button_focus_active_hover    = themes_path .. "titlebar/maximize_hover.svg"

theme.titlebar_maximized_button_normal_inactive       = themes_path .. "titlebar/unfocus.svg"
theme.titlebar_maximized_button_focus_inactive        = themes_path .. "titlebar/maximize.svg"
theme.titlebar_maximized_button_normal_inactive_hover = themes_path .. "titlebar/maximize_hover.svg"
theme.titlebar_maximized_button_focus_inactive_hover  = themes_path .. "titlebar/maximize_hover.svg"

theme.wallpaper                                       = themes_path .. "buttons.png"
...
theme.window_switcher_widget_bg            = theme.xcolorbase -- The bg color of the widget
...
theme.window_switcher_name_normal_color    = theme
    .xcolorT0                                                 -- The color of one title if the client is unfocused
theme.window_switcher_name_focus_color     = theme
    .xcolor5                                                  -- The color of one title if the client is focused
