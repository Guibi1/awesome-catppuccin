...
local editor_cmd = apps.terminal .. " -e code "
...
menu.mainmenu = awful.menu {
    items = {
        ...
        { "Info Panel",    function() awesome.emit_signal("info-panel::toggle") end },
        { "Notifications", function() awesome.emit_signal("notif-panel::toggle") end },
